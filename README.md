...
Перекраска иконки применяется только к SVG. Технически плагин использует SVG как одноцветную маску, поэтому сложные многоцветные SVG, PNG, WebP, JPG и JPEG лучше оставлять в оригинальном режиме.
