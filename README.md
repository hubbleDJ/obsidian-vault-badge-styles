...
- Использовать встроенные иконки плагина для задач, статусов, приоритетов и проектов.
...
Эта папка создается при загрузке плагина и содержит базовые иконки для задач, статусов, приоритетов и проектов. Их можно указывать без расширения:
...
Если в пользовательской папке есть иконка с таким же именем, она будет использована раньше встроенной.
...
Экспортируются только настройки. Пользовательские файлы иконок не упаковываются в архив и должны лежать в vault отдельно. Встроенные иконки плагина создаются автоматически в `.obsidian/plugins/vault-badge-styles/icons`.
